 ...
 *Adds separators to a table view cell with a given height.
 ...
 @return A separator view with the given separators and height. This method also sets the returned separator view as the first subview of the reciever's content view.
 */
 ...
 *Adds separators to a table view cell with a given height.
 ...
 @return The separator view of the specified subclass. This method also sets the returned separator view as the first subview of the reciever's content view.
 */
- (VENSeparatorView *)addTopLineSeparatorType:(VENSeparatorType)topLineSeparatorType
                      bottomLineSeparatorType:(VENSeparatorType)bottomLineSeparatorType
                                   cellHeight:(CGFloat)height
